...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String url = "https://api.myjson.com/bins/13ixes";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.feedback) {
            ...
            i.putExtra(Intent.EXTRA_EMAIL  , new String[]{"santhakumarsoftwareengineer@gmail.com"});
            i.putExtra(Intent.EXTRA_SUBJECT, "Feedbacks of KeralaPlace App");
